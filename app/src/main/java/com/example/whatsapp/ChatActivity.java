...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Toast.makeText(ChatActivity.this, messageReceiverID, Toast.LENGTH_SHORT).toString();
        //Toast.makeText(ChatActivity.this,messageReceiverName,Toast.LENGTH_SHORT).toString();
        //Toast.makeText(ChatActivity.this,messageReceiverImage,Toast.LENGTH_SHORT).toString();
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data)
    {
        ...
        if (requestCode==438 && resultCode==RESULT_OK && data != null && data.getData() != null)
        {
            ...
            loadingBar.setMessage("Please wait,sending the file...");
            ...
            {
                loadingBar.dismiss();
                Toast.makeText(this,"Nothing Select, Error", Toast.LENGTH_SHORT);
            }
